...
export default function CitizenApp() {
  ...
  return (
    <div className="grid h-full place-items-center bg-gradient-to-b from-hud-bg to-hud-bg2 p-3">
      <div className="phone-frame flex flex-col bg-hud-bg text-hud-text">
          ...
          <div>
            ...
            <label className="mt-0.5 flex items-center gap-1 text-lg font-extrabold text-hud-text">
              ...
              <select
                ...
                className="max-w-[13rem] cursor-pointer appearance-none bg-transparent font-extrabold text-hud-text outline-none"
